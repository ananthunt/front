...
export default function AddContractor(){
    ...
    return(
            <div>
                ...
                <Button className ="add-button" size="small" variant="contained" onClick={onModalOpen} >Add Contractor</Button>
                </div>
                <div>
                <Offcanvas className="offcanvas-size"  show={onshow} onHide={onModalClose} placement="end" >
                    <Offcanvas.Header closeButton className="offcanvas-header-text">Add Contractor</Offcanvas.Header>
